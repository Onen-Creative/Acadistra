...
import { IconBell, IconPlus, IconAlertCircle, IconSparkles } from '@tabler/icons-react';
          ...
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 p-8 shadow-2xl">
            ...
            <div className="relative z-10">
              <Group gap="md" mb="sm">
                ...
                <div>
                  <Title order={1} className="text-white mb-1">System Announcements</Title>
                  <Text size="sm" className="text-blue-100">
                    Send important updates and notifications to all users
                  </Text>
                </div>
              </Group>
            </div>
        ...
        <Stack gap="lg">
          ...
          <Paper shadow="md" radius="lg" className="overflow-hidden border border-gray-100">
            <Tabs value={activeTab} onChange={setActiveTab} variant="pills">
              <Tabs.List className="bg-gradient-to-r from-gray-50 to-blue-50/30 p-4 border-b border-gray-100">
                <Tabs.Tab 
                  value="create" 

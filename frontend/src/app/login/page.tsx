  ...
  const onSubmit = async (data: LoginForm) => {
    try {
      ...
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL || "https://acadistra.com"}/api/v1/auth/login`,
        {
          method: "POST",
          ...
          result.user.role === "parent"
            ...
            : result.user.role === "system_admin"
              ...
              : result.user.role === "school_admin"
                ...
                : result.user.role === "director_of_studies"
                  ? "/dashboard"
            ...
            <div className="mb-8 animate-fade-in-delay-1">
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                ...
                <p className="text-white/90 text-lg leading-relaxed mb-4 italic">
                  "Acadistra has transformed how we manage our school. The
                  offline marks entry and automated grading save us hours every
                  term."
                </p>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-200 text-sm">
                      Nabumali Secondary School, Mbale
                    </p>
                  </div>
                </div>
              </div>
